...
The system SHALL return a standardized error JSON structure for all failures, including validation errors, application logic errors, and unexpected server exceptions.
...
- **THEN** the server SHALL log the full error stack to the console (stderr)
